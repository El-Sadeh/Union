...
PrimitiveUnion *
PrimitiveUnionPluginSupport_create_data(void)
{
    try {
        PrimitiveUnion *sample = new PrimitiveUnion;    
...
void 
PrimitiveUnionPluginSupport_destroy_data(
    PrimitiveUnion *sample) 
{
    delete sample;
}

RTIBool 
PrimitiveUnionPluginSupport_copy_data(
    PrimitiveUnion *dst,
    const PrimitiveUnion *src)
{
    try {
        *dst = *src;
    } catch (...) {
...
PrimitiveUnionPlugin_on_participant_attached(
...
void 
PrimitiveUnionPlugin_on_participant_detached(
...
PrimitiveUnionPlugin_on_endpoint_attached(
    PRESTypePluginParticipantData participant_data,
    ...
    void *containerPluginContext)
{
    try {
        ...
        epd = PRESTypePluginDefaultEndpointData_new(
            ...
            PrimitiveUnionPluginSupport_create_data,
        ...
        if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
            serializedSampleMaxSize = PrimitiveUnionPlugin_get_serialized_sample_max_size(
            ...
            if (PRESTypePluginDefaultEndpointData_createWriterPool(
                ...
                PrimitiveUnionPlugin_get_serialized_sample_max_size, epd,
                (PRESTypePluginGetSerializedSampleSizeFunction)
                PrimitiveUnionPlugin_get_serialized_sample_size,
                epd) == RTI_FALSE) {
...
void 
PrimitiveUnionPlugin_on_endpoint_detached(
...
void    
PrimitiveUnionPlugin_return_sample(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion *sample,
    void *handle)
{
...
RTIBool 
PrimitiveUnionPlugin_copy_sample(
    PRESTypePluginEndpointData,
    PrimitiveUnion *dst,
    const PrimitiveUnion *src)
{
    return PrimitiveUnionPluginSupport_copy_data(dst,src);
}
...
* ------------------------------------------------------------------------- */
unsigned int 
PrimitiveUnionPlugin_get_serialized_sample_max_size(
    PRESTypePluginEndpointData endpoint_data,
...
RTIBool 
PrimitiveUnionPlugin_serialize(
    PRESTypePluginEndpointData endpoint_data,
    const PrimitiveUnion *sample, 
...
RTIBool 
PrimitiveUnionPlugin_deserialize_sample(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion *sample,
    struct RTICdrStream *stream,   
...
RTIBool
PrimitiveUnionPlugin_serialize_to_cdr_buffer(
    char * buffer,
    unsigned int * length,
    const PrimitiveUnion *sample)
{
    try{
        ...
        result = PrimitiveUnionPlugin_serialize(
...
RTIBool
PrimitiveUnionPlugin_deserialize_from_cdr_buffer(
    PrimitiveUnion *sample,
    const char * buffer,
    unsigned int length)
{
    ...
    rti::topic::reset_sample(*sample);
    return PrimitiveUnionPlugin_deserialize_sample( 
        NULL, sample,
...
RTIBool 
PrimitiveUnionPlugin_deserialize(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion **sample,
    RTIBool * drop_sample,
    struct RTICdrStream *stream,   
    ...
    void *endpoint_plugin_qos)
{
    try {
        RTIBool result;
        const char *METHOD_NAME = "PrimitiveUnionPlugin_deserialize";
        if (drop_sample) {} /* To avoid warnings */

        stream->_xTypesState.unassignable = RTI_FALSE;
        result= PrimitiveUnionPlugin_deserialize_sample( 
...
RTIBool PrimitiveUnionPlugin_skip(
    PRESTypePluginEndpointData endpoint_data,
    struct RTICdrStream *stream,   
...
unsigned int 
PrimitiveUnionPlugin_get_serialized_sample_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    ...
    unsigned int current_alignment)
{
    try {
        ...
        size = PrimitiveUnionPlugin_get_serialized_sample_max_size_ex(
...
unsigned int 
PrimitiveUnionPlugin_get_serialized_sample_min_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
...
PrimitiveUnionPlugin_get_key_kind(void)
{
    return PRES_TYPEPLUGIN_NO_KEY;
}

RTIBool 
PrimitiveUnionPlugin_serialize_key(
    PRESTypePluginEndpointData endpoint_data,
    const PrimitiveUnion *sample, 
    struct RTICdrStream *stream,    
    RTIBool serialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if(serialize_key) {
            ...
            if (!PrimitiveUnionPlugin_serialize(
                endpoint_data,
                sample,
                stream,
...
RTIBool PrimitiveUnionPlugin_deserialize_key_sample(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion *sample, 
    struct RTICdrStream *stream,
    RTIBool deserialize_encapsulation,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (deserialize_key) {
            ...
            if (!PrimitiveUnionPlugin_deserialize_sample(
...
RTIBool PrimitiveUnionPlugin_deserialize_key(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion **sample, 
    RTIBool * drop_sample,
    struct RTICdrStream *stream,
    ...
    void *endpoint_plugin_qos)
{
    try {
        ...
        if (drop_sample) {} /* To avoid warnings */
        stream->_xTypesState.unassignable = RTI_FALSE;
        result= PrimitiveUnionPlugin_deserialize_key_sample(
...
unsigned int
PrimitiveUnionPlugin_get_serialized_key_max_size_ex(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool * overflow,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    ...
    current_alignment += PrimitiveUnionPlugin_get_serialized_sample_max_size_ex(
...
unsigned int
PrimitiveUnionPlugin_get_serialized_key_max_size(
    PRESTypePluginEndpointData endpoint_data,
    RTIBool include_encapsulation,
    RTIEncapsulationId encapsulation_id,
    unsigned int current_alignment)
{
    try {
        ...
        size = PrimitiveUnionPlugin_get_serialized_key_max_size_ex(
            endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
...
RTIBool 
PrimitiveUnionPlugin_serialized_sample_to_key(
    PRESTypePluginEndpointData endpoint_data,
    PrimitiveUnion *sample,
    struct RTICdrStream *stream, 
    RTIBool deserialize_encapsulation,  
...
* ------------------------------------------------------------------------ */
struct PRESTypePlugin *PrimitiveUnionPlugin_new(void) 
{ 
    ...
    PrimitiveUnionPlugin_create_sample;
    plugin->destroySampleFnc =
    (PRESTypePluginDestroySampleFunction)
    PrimitiveUnionPlugin_destroy_sample;
    ...
    PrimitiveUnionPlugin_get_sample;
    ...
    PrimitiveUnionPlugin_get_key_kind;
    ...
    */
    ...
    &rti::topic::dynamic_type<PrimitiveUnion>::get().native();
    ...
    PrimitiveUnionPlugin_get_buffer;
    plugin->returnBuffer = 
    (PRESTypePluginReturnBufferFunction)
    PrimitiveUnionPlugin_return_buffer;
    plugin->getSerializedSampleSizeFnc =
    (PRESTypePluginGetSerializedSampleSizeFunction)
    PrimitiveUnionPlugin_get_serialized_sample_size;

    static const char * TYPE_NAME = "PrimitiveUnion";
...
void
PrimitiveUnionPlugin_delete(struct PRESTypePlugin *plugin)
{
    ...
    unsigned int current_alignment)
{
    try {
        ...
        current_alignment +=PrimitiveUnionPlugin_get_serialized_sample_min_size(
    ...
    const myStruct * sample) 
{
    try {  
        ...
        current_alignment += PrimitiveUnionPlugin_get_serialized_sample_size(
            endpoint_data,RTI_FALSE, encapsulation_id,
            current_alignment, &sample->theUnion());
